         ...
         <tbody>
          <?php foreach($data as $index => $d){ ?>
            <tr>
              ...
              <td class='text-center' style="color:rgb(154, 218, 227);"><a  style="color:rgb(154, 218, 227);"href="http://localhost/exam/Admin/ViewStudent.php">
              ...
              <td class='text-center' style="color:rgb(154, 218, 227);"><a  style="color:rgb(154, 218, 227);"href="http://localhost/exam/Admin/DeleteStudent.php?student_id=<?php echo $d['student_id'] ?>" onclick="return confirm('Please click on OK to continue.');">
